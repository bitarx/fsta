...
<title>白石市学習塾「ふりスタ学習塾」| <?php if ($pageName === 'Home') : ?>自由な形式の学習形態<?php else: ?>{{$pageName}}<?php endif; ?></title>
...
<header id="header" role="banner">
    <div class="inner">
        <h1>白石市学習塾「ふりスタ学習塾」</h1>
        <h2><a href="/"><img src="/images/banners/logo-new.png" alt=""></a></h2>
	<div class="contact">
