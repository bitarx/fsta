    ...
    <div id="content">
        <section>
            <article id="desc" class="content">
                ...
                <div class="post">
                    <p>「 Free　Style　Study　System 」（ フリー・スタイル・スタディ・システム ）の略称で、「  学習時間や学習指導教科において、『できる限り自由であること』 」を目的としています。</p>
                    ...
                    <p><img src="images/banners/desc1.png" alt="" width="201" class="alignleft">
                        ...
                        ・その日の学習内容において、生徒さんから特にリクエストがない場合、教室長の準備した教材の中から、生徒さんにその日の学習内容を決めて頂きます。
                        　<br>
                        　一方的にその日の指導内容を決めることはありません。<br>
                        ・国語や英語の「 長文の読み合わせ 」などにも、じっくり時間を使えます。<br><br>

                        <span class="strong">B. 「スタンダード・個別指導プラン」〔小・中学生対象：1クラス3人程度〕</span><br>
                        ・直近の「 定期試験対策 」や「 模擬試験対策 」が第一目標になります。<br>
                        ・生徒さん一人ひとりの「 短期目標 」に従い、教室長が指示する内容を学習します。<br>
                        　その為、生徒さん一人ひとりの学習内容も変わります。<br><br>

                        <span class="strong">C. 「 季節講習・特訓講習スタンダードプラン 」〔 小・中学生対象：少人数クラス指導 〕</span><br>
...
1対1指導の指導時間が、ひと月で8時間を超えた場合、『 スタンダード授業 』が割引になります。1対1指導で弱点を克服し、演習を繰り返し知識の定着をはかるのが目的なので、指導コマ数が必要な生徒さん中心に声掛けをします。1対1指導と集団指導の融合スタイルです。
...
※	模擬試験の偏差値レベルで1教科+10以上、模擬試験の総合点数レベルで+100点以上上がる生徒が、毎年1～2人必ずいます。
                    ...
                    <table class="statsDay">
                        <tr><td>２月９日(土)</td><td><span class="strong">【 中３生対象 】</span></td></tr>
        ...
        <section>
            ...
            <article class="content">
                <div class="post toppage">
                    <table>
                        <tbody>
                    <p><span class="strongMessage">☆入試直前・特訓講習会『 ふりスタ・冬の陣 』</span></p>
                    <p>※中３生の募集は締め切りました</p>
                    <p>特訓講習会「ふりスタ・新春の陣」</p>
                            <tr>
                                <th>講習日</th>
                                <td>1月15日（火）　～　3月31（日）</td>
                            </tr>
                            <tr>
                                <th>時間１（土・日・祝日）</th>
                                <td>朝 9：00　～　昼 13：00</td>
                            </tr>
                            <tr>
                                <th>時間２(平日)</th>
                                <td>夜 19：00　～　夜 21：30(曜日限定)<br>※詳しくは、教室にお尋ねください。</td>
                            </tr>
                            <tr>
                                <th>学習時間</th>
                                <td>90分 ～ 120分</td>
                    ...
                    <br>
<br>
<span class="strongMessage">②　中学1～2年生対象　：　「　定期試験　＆　模擬試験対策勉強会　」</span><br>
☆ 個別指導　6時間コース　￥6,000（ お試しコースです ）<br>
☆ 個別指導　6時間コース　￥8,000（ 模擬試験付コースです ）※模擬試験は3月23日(土)実施が対象になります。<br>
<span class="strongMessage">③　小学生対象　：　「　ふりスタでがんばろう！　」</span><br>
☆　（ 最初の ）1か月間の月謝の上限が　￥1,000になります。（ 60分、４回 ）<br>
☆　模擬試験付きコース（ 最初の ）1か月間の月謝の上限が　￥3,000になります。（ 60分、4回）+模擬試験（3月23日（土）実施）<br>
※ 季節講習受講者の模擬試験の差額は塾が負担いたします。<br>
※　テキスト1冊の全てを解く、授業内容ではありません。<br>
</p>
                </div>
            </article>
...
<br>
<p>『 ふりスタ学習塾 』は「 定期試験の成績はもちろん、模擬試験の偏差値を上げる 」塾なのです。</p>
                </div>
            </article>
        </section>
        <section>
...
【 仙台高専合格実績 】　<br>　逸材に更なる磨きをかけます。 <br>☆ 仙台高専・電気科専攻科（推薦合格）（H28） ← 仙台高専・電気システム学科（H24） ← 角田中出身<br><br>【専攻科総合No.1】<br> ☆ 仙台高専・建築デザイン学科（推薦）(H28)　← 遠刈田中出身【学年総合1位】<br>
☆ 仙台高専・マテリアル環境（推薦）（H26）← 金津中出身 【微積・物理学年No.1】<br>

</p>
<p>
【 成績上昇例 】<br>　過去の「新みやぎ模試」の受験結果です。1対1指導で1年半年以上
...
<br>
<span class="notice">★シーズン2　[ 2011年 ～ 2015年 ]</span><br>
☆[ 5教科合計V字型：女子 ] 200(中3春) → 166(9月) → 346(後期選抜) 【英語偏差値+9、数学偏差値+13、理科偏差値+16、総合偏差値+9】<br>
☆[ 偏差値維持型(5教科)：男子 ] 62(中3夏) → 63(8月) → 68(12月)<br>
☆[ 偏差値上昇型(5教科)：男子 ] 40(中3春) → 46(10月) → 49(1月)<br> 
☆[ 偏差値上昇型(5教科)：男子 ] 48(中3夏) → 50(10月) → 54(2月) 【英語偏差値+10、社会偏差値+12、理科偏差値+10】  ☆[ 偏差値上昇型(国語)：男子 ] 27(中3春) → 32(8月) → 46(1月)<br>
<br>
<span class="notice">★シーズン3　[ 2016年 ～ 2018年 ]</span><br>
　成績急上昇者激増中 !! <br>
☆[ 5教科上昇型：男子 ] 92(中3春) → 139(8月) → 191(後期選抜) <br>
　※3教科+合計で自己ベスト達成【理科偏差値+11、総合偏差値+7】<br>
☆[ 5教科上昇型：男子 ] 126(中3春) → 160(10月) → 211(後期選抜)<br>
　※3教科+合計で自己ベスト達成【国語偏差値+15、理科偏差値+10、総合偏差値+6】<br>
☆[ 偏差値上昇型(理科)：女子 ] 31(中3春) → 39(10月) → 48(1月)【総合偏差値+4】<br><br>

<span class="purple">★短期急上昇例</span><br>　極めて稀なケースです。指導時間が極端に短い為、ある意味で「賭け」になります。<br>
