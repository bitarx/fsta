    ...
    <div id="content">
        <section>
            <article id="desc" class="content">
                ...
                <div class="post">
                    <p>「 Free　Style　Study　System 」（ フリー・スタイル・スタディ・システム ）の略称で、「 自由な形式の学習形態 」を意味しています。</p>
                    ...
                    <p><img src="images/banners/desc1.png" alt="" width="201" class="alignleft">
                        ...
                        <span class="strong">B. 「スタンダード・個別指導プラン」〔中学生対象：少人数・個別指導スタイル〕</span><br>
                        ・直近の「 定期試験対策 」や「 模擬試験対策 」が第一目標になります。<br>
                        ・生徒さん一人ひとりの「 短期目標 」に従い、教室長が指示する内容を学習します。<br>
                        　その為、生徒さん一人ひとりの学習内容も変わります。<br>
                        　「 定期試験対策 」や「 模擬試験対策 」が、5回～10回受講できます。<br><br>

                        <span class="strong">C. 「 特訓講習スタンダードプラン 」〔 中学生対象：少人数クラス指導 〕</span><br>
                        ・知識を定着させ、偏差値を安定させることが最大の目標です。<br>
                        ・問題演習に特化したコースになります。<br>
                        ・教室長の用意した問題の演習中心の学習になります。<br>
                        ・時間の許す限り、とにかく問題を解きまくるコースです。<br><br>
...
<span class="strong">☆とことん・ふりスタ・システム≪ New ! ≫</span><br>
...
※	成績クレームは、ほぼありません( 過去20年で1回だけあります )。<br>
※	1度達成したら終わりではありません。1対1指導を継続する限り、「 成績保証 」の対象となります。
</p>
...
・〔 高専生 〕定期試験対策(重積分、ラプラス変換、フーリエ解析まで指導します)
                    ...
                    <h3>中学生 ＆ 高校受験生</h3>
                    <p>
・<span class="strongMessage">『Go to the TOP』〔高(ナンバースクール＆国立高専) 狙い撃ちコース〕</span><br>
