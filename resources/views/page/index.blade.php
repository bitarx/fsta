    ...
    <div id="content">
        ...
        <section>
            ...
            <article class="content">
                ...
                <div class="post toppage">
                    <p><span class="strongMessage">無料体験指導・実施中!！</span><br>小学生・中学生が対象となります。</p>
                    <table>
                        <tbody>
                            <tr>
                                <th>①   無料体験指導</th>
...
※	指導時間帯　月 ～ 金 〔 平日 〕　15：30～19：00　（ 原則として ）<br>
キッズスタンダードは学習可能な時間に教室に来ていただき、学習をするスタイルになります。指導時間に過不足が出た場合、翌月に繰り越します。その場合、月謝は30分単位の清算になります。少人数指導が基本ですが、時間帯によって、1対1の指導になることもあります。
                    ...
                    （4） ご家庭での指導を希望する場合、別途派遣費用が必要になります。<br>
                     （5） 併塾の問題はありませんが、学習指導内容の重複を避けるため、他塾さんでの学習指導の進捗状況をお伺いさせて頂きます。<br>
                    （6） 退塾・休塾は自由です。お引止めはしませんが、塾に復帰する場合、一定の条件を加えさせて頂く場合があります。<br>
                    （7） 学習指導の時間帯と料金は飽くまでも目安となります。時間を延長して授業を受けた場合や、時間を短縮して授業を受けた場合は30分単位の清算になります。<br>
                    （8） 季節や時間帯によって（講師のスケジュールの都合上）、指導日時が塾優先で相談させていただく場合があります。<br>
                    </p>
                </div>
            </article>
        </section>
...
<p>・<span class="highschool">柴田高校</span>（5名うち2名が前期合格、体育学科・前期１名）</p>
