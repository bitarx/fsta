        ...
        <section>
            <article id="desc" class="content">
                ...
                <div class="post">
                    ...
                    <h3>☆ 『 成績保障制度 』</h3>
                    <p>A．入塾時より偏差値を上げることを目標にします。安定した偏差値の維持が目標になります。<br><br>
B．定期試験の成績を上げることを目標にします。<br><br>
いずれも、( 指導の結果として )成績が芳しくない場合、季節講習費が格段に割安になります。成績の向上には時間がかかることをご理解ください。<br><br></p>
                    ...
                    <table class="statsDay">
                        ...
                        <tr><td>３月24日(日)</td><td><span class="strong">【 小５〜中２生対象 】</span></td></tr>
                            ...
                            午前の部　 9時～13時20分<br>
                            午後の部　14時～18時20分<br>料金は、3,500円（消費税込み）<br>（申し込み締め切りは、いずれも実施日の一週間前までです）<br>
...
キッズスタンダードは学習可能な時間に教室に来ていただき、学習をするスタイルになります。指導時間に過不足が出た場合、翌月に繰り越します。その場合、月謝は30分単位の清算になります。少人数指導が基本ですが、時間帯によって、1対1の指導になることもあります。
                    ...
                    （5） 学習指導の時間帯と料金は飽くまでも目安となります。時間を延長して授業を受けた場合や、時間を短縮して授業を受けた場合は30分単位の清算になります。90分コースもあります。<br>
                    </p>
                </div>
            </article>
        </section>
...
・〔 限界突破・集中特訓指導コース 〕<br>
学習に対する意識改革及び、学習習慣の定着が目的となります。5教科で100点前後の生徒さんでも大丈夫です。毎年一人か二人、+100点ほど成績が上がる生徒さんがいます。学力の飛躍的な向上には、時間がかかることをご理解ください。<br><br>
・〔 数学マスターコース 〕<br>
